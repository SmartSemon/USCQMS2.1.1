...
public class MDefaultValues {
	...
	public static List<Map<String, Object>> getDefaultField(int itemType, String itemid) {
		...
		MapSTATE.put("editor", "MapValueList");
		MapSTATE.put("editparams",
				"{\"values\":[{\"name\":\"维护中\",\"color\":\"\",\"key\":\"C\"},{\"name\":\"签审中\",\"color\":\"\",\"key\":\"E\"},{\"name\":\"已归档\",\"color\":\"\",\"key\":\"F\"},{\"name\":\"检出\",\"color\":\"\",\"key\":\"U\"}]}");
