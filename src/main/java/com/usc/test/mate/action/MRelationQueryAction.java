...
public class MRelationQueryAction {
	...
	private static String[] getCondition(String table, String con) {
		...
		String v = null;
		if (table.equals("usc_model_mq_listener") || table.equals("usc_model_field") || table.equals("usc_model_grid")
				|| table.equals("usc_model_itemmenu") || table.equals("usc_model_property")
				|| table.equals("usc_model_relationpage") || table.equals("usc_model_classview_node"))
		{
			if (con != null)
			{
		...
		return new String[] { condition.toString() + " ORDER BY sort", v };
	}
}
