...
public class FormatUtils
{
	...
	private static void cacheProperties(String... propNames)
	{
		try
		{
	...
	public static String getValue(String key, String... propNames)
	{
		if (ObjectHelperUtils.isNotEmpty(key) && ObjectHelperUtils.isNotEmpty(propNames))
		{
			for (String propName : propNames)
			{
